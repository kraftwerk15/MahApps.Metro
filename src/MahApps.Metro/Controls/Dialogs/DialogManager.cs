...
namespace MahApps.Metro.Controls.Dialogs
{
    public static class DialogManager
    {
        ...
        private static MetroWindow CreateExternalWindow(Window? windowOwner = null)
        {
            ...
            {
                window.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Steel_Yard.MahApps.Metro;component/Styles/Controls.xaml", UriKind.RelativeOrAbsolute) });
                window.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Steel_Yard.MahApps.Metro;component/Styles/Fonts.xaml", UriKind.RelativeOrAbsolute) });
